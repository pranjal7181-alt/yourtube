 ...
 */
const InvalidWebhookErrorMessages = {
...
class VideoApi {
    ...
    async queryCallSessionStats(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/video/call_stats', undefined, undefined, body, 'application/json');
...
class ModerationApi {
    ...
    async bypass(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/moderation/bypass', undefined, undefined, body, 'application/json');
    ...
    async deleteModerationRule(request) {
        ...
        const response = await this.apiClient.sendRequest('DELETE', '/api/v2/moderation/moderation_rule/{id}', undefined, queryParams);
    ...
    constructor(apiConfig) {
        ...
        this.sendRequest = async (method, url, pathParams, queryParams, body, requestContentType) => {
            ...
            const headers = {
                ...
                'X-Stream-Client': 'stream-node-' + "0.7.62",
...
class FeedsApi {
    ...
    async batchQueryActivityReactions(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/feeds/activities/reactions/query', undefined, undefined, body, 'application/json');
    ...
    async batchQueryCommentReactions(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/feeds/comments/reactions/query', undefined, undefined, body, 'application/json');
    ...
    async updateCommentBookmark(request) {
        ...
        const response = await this.apiClient.sendRequest('PATCH', '/api/v2/feeds/comments/{comment_id}/bookmarks', pathParams, undefined, body, 'application/json');
    ...
    async addCommentBookmark(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/feeds/comments/{comment_id}/bookmarks', pathParams, undefined, body, 'application/json');
    ...
    async getOrCreateFollow(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/feeds/follows/upsert', undefined, undefined, body, 'application/json');
    ...
    async queryRevisionHistory(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/feeds/revisions/query', undefined, undefined, body, 'application/json');
    ...
    async getOrCreateUnfollow(request) {
        ...
        const response = await this.apiClient.sendRequest('POST', '/api/v2/feeds/unfollow/upsert', undefined, undefined, body, 'application/json');
...
class StreamClient extends CommonApi {
    ...
    constructor(apiKey, secret, config) {
         ...
         */
        this.verifyAndParseWebhook = (rawBody, signature) => {
            if (!this.secret) {
                throw new InvalidWebhookError('cannot verify webhook signature without an API secret on the client');
            }
         ...
         */
        this.parseSqs = (messageBody) => parseSqs(messageBody);
        /**
         ...
         */
        this.parseSns = (notificationBody) => parseSns(notificationBody);
...
exports.InvalidWebhookErrorMessages = InvalidWebhookErrorMessages;
